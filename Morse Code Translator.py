...
var = IntVar()
canvas = Canvas(window, width=800, height=500, background="green")
canvas.pack()

input_txt = Entry(window, width=50, font=('Times New Roman', 15), background="lightgreen")
input_msg = Label(window, text="Input the text or morse code to translate", font=('Times New Roman', 20), background="green")

canvas.create_window(400, 170, window=input_txt)
canvas.create_window(400, 100, window=input_msg)

button1 = Radiobutton(window, text="Morse to Text", variable=var, value=1, font=('Times New Roman', 15), background="green")
button2 = Radiobutton(window, text="Text to Morse", variable=var, value=2, font=('Times New Roman', 15), background="green")
translate = Button(window, text="Translate", command=select_process, font=('Times New Roman', 13), background="white")
output = Entry(window, width=50, font=('Times New Roman', 20), background="lightgreen")
